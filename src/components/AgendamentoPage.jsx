    ...
    return (
        <div className="container mx-auto p-4 max-w-4xl">
            ...
            <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg shadow-lg space-y-6">
                ...
                <div><label htmlFor="observacoes" className="block text-sm font-medium text-gray-700 mb-1">5. Observações (Opcional)</label><textarea id="observacoes" value={observacoes} onChange={(e) => setObservacoes(e.target.value)} rows="3" className="w-full border border-gray-300 rounded-md p-3 focus:ring-2 focus:ring-amber-500" placeholder="Ex: Alergia a algum produto, preferência de máquina, etc."></textarea></div>
